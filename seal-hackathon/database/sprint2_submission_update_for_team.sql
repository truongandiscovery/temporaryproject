-- =======================================================
-- SEAL Sprint 2 Team Update
-- Feature: Submission Management, Submission Validation, Submission History
--
-- Use this file for teammates who already have a Sprint 1 database and need
-- the minimum database objects required to continue Sprint 2 work.
-- Safe to rerun: every CREATE/ALTER is guarded when possible.
-- =======================================================

USE SEAL_Hackathon_G06;
GO

-- 1. Align Team default status with backend workflow.
...
-- 3. Submission history/audit trail.
...
-- 4. Minimal ranking table for next-round qualification checks.
...
-- 5. Verify Sprint 2 database objects.
SELECT
