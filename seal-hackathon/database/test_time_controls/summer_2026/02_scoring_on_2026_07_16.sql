...
SET
    start_at = CASE
        WHEN round_name = N'Elimination' THEN '2026-06-25T08:00:00'
        WHEN round_name = N'Finals' THEN '2026-07-10T08:00:00'
        ELSE start_at
    END,
    submission_deadline = CASE
        WHEN round_name = N'Elimination' THEN '2026-07-05T23:59:00'
        WHEN round_name = N'Finals' THEN '2026-07-15T23:59:00'
