...
SET
    registration_start_at = '2026-06-12T08:00:00',
    registration_end_at   = '2026-06-20T23:59:00',
    competition_start_at  = '2026-06-25T08:00:00',
...
SET
    start_at = CASE
        WHEN is_final = 0 THEN '2026-06-25T08:00:00'
        WHEN is_final = 1 THEN '2026-07-15T08:00:00'
        ELSE start_at
    END,
    submission_deadline = CASE
        WHEN is_final = 0 THEN '2026-06-30T23:59:00'
