...
SET
    registration_start_at = '2026-06-01T08:00:00',
    registration_end_at   = '2026-06-10T23:59:00',
    competition_start_at  = '2026-06-12T08:00:00',
...
SET
    start_at = CASE
        WHEN is_final = 0 THEN '2026-06-12T08:00:00'
        WHEN is_final = 1 THEN '2026-07-15T08:00:00'
        ELSE start_at
    END,
    submission_deadline = CASE
        WHEN is_final = 0 THEN '2026-06-20T23:59:00'
        WHEN is_final = 1 THEN '2026-07-18T23:59:00'
        ELSE submission_deadline
    END,
    end_at = CASE
        WHEN is_final = 0 THEN '2026-06-21T12:00:00'
        WHEN is_final = 1 THEN '2026-07-18T23:59:00'
        ELSE end_at
    END
WHERE event_id = @event_id;
